      ...
      <div style={containerStyle}>
        ...
        <div style={{ width: '100%', backgroundColor: 'white', color: '#333', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', textAlign: 'center', backgroundColor: '#eee', padding: '2px 0' }}>
            ...
            <div><p style={{ fontSize: '20px', fontWeight: '900', margin: 0, color: '#666' }}>PAR</p><p style={{ fontSize: '85px', fontWeight: '900', lineHeight: 0.8, margin: 0 }}>{courseData[currentHole].par}</p></div>
            <div><p style={{ fontSize: '20px', fontWeight: '900', margin: 0, color: '#666' }}>S.I.</p><p style={{ fontSize: '85px', fontWeight: '900', lineHeight: 0.8, margin: 0 }}>{courseData[currentHole].si}</p></div>
          </div>
          ...
          <div style={{ textAlign: 'center', padding: '5px 0' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                <button onClick={() => { const n = [...scores]; n[currentHole] = 0; setScores(n); }} style={{ width: '90px', height: '50px', backgroundColor: '#666', color: 'white', borderRadius: '10px', fontSize: '30px', fontWeight: '900', border: 'none' }}>PU</button>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-around', backgroundColor: '#e8f5e9', padding: '2px 0' }}>
            <div style={{ textAlign: 'center' }}><p style={{ fontSize: '22px', color: '#16a34a', fontWeight: '900', margin: 0 }}>PTS</p><p style={{ fontSize: '85px', fontWeight: '900', lineHeight: 0.8, margin: 0 }}>{calcPoints(scores[currentHole], courseData[currentHole].par, courseData[currentHole].si)}</p></div>
